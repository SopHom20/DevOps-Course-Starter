...
@pytest.mark.parametrize("items, expected", [(default_items, default_items), (done_items, []),
                                             (default_items + done_items, default_items)])
...
@pytest.mark.parametrize("items, expected",
                         [(default_items, []), (done_items, done_items), (default_items + done_items, done_items)])
def test_view_model_gets_not_started_items(items, expected):
    item_view_model = ViewModel(items)
