...
A trello board with at least two lists is required to use this Flask app (the name of these lists don't matter). The id of this trello board should be placed in the `.env` file
## Running the App
